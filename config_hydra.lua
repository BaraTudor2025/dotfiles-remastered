...
local window_hydra = Hydra({
  ...
  heads = {
    -- Buffers
    { 'u', '<Plug>(CybuPrev)' }, -- <plug>CybuLastusedPrev
    { 'i', '<Plug>(CybuNext)' }, -- <plug>CybuLastusedNext
    { 'T', '<c-w>T'},
...
vim.api.nvim_create_user_command('ToggleQuickWords',
  function ()
    quick_words_hydra:activate()
  end, {})

vim.api.nvim_create_user_command('HydraWindow',
  function ()
    window_hydra:activate()
  end, {})

vim.api.nvim_create_user_command('GitHydra',
  function ()
    gitsigns_hydra:activate()
  end, {})

vim.api.nvim_create_user_command('HydraSideScroll',
  function ()
    horiz_scroll:activate()
  end, {})

return {
  setup = function() --[[lmao]] end,
}
